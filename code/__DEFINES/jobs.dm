...
#define JOBS_LAZARUS "Lazarus Biolab Officer","Medical Doctor","Psychiatrist","Chemist","Trauma Team", "Lazarus Expedition Overseer","Scientist","Roboticist" //Eclipse Edit - Replaced Paramedic with Trauma Team
